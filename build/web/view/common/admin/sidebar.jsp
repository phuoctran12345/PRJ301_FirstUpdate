...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <li><a class="app-menu__item ${requestScope.CURRENTSERVLET == "User" ? "active" : ""}" href="UserManagementServlet"><i class='app-menu__icon bx bx-user-voice'></i><span
                    class="app-menu__label">Quản lý khách hàng</span></a></li>
        <li><a class="app-menu__item ${requestScope.CURRENTSERVLET == "Product" ? "active" : ""}" href="ProductManagementServlet"><i class='app-menu__icon bx bx-purchase-tag-alt'></i><span 
                    class="app-menu__label">Quản lý sản phẩm</span></a></li>
        <li><a class="app-menu__item ${requestScope.CURRENTSERVLET == "Category" ? "active" : ""}" href="CategoryManagementServlet"><i class='app-menu__icon fa fa-layer-group'></i><span
        ...
        <li><a class="app-menu__item ${requestScope.CURRENTSERVLET == "Suppliers" ? "active" : ""}" href="ManageSupplierServlet"><i class='app-menu__icon bx bx-task'></i><span
